...
A64_CASE(a64_ucvtf(0, A64_F64, 0, 1),		"ucvtf d0, w1")
A64_CASE(a64_ucvtf(1, A64_F64, 2, 3),		"ucvtf d2, x3")
A64_CASE(a64_fcvtzu(0, A64_F64, 4, 5),		"fcvtzu w4, d5")
A64_CASE(a64_fcvtzu(1, A64_F32, 6, 7),		"fcvtzu x6, s7")
